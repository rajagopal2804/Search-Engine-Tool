...
<head>
    ...
    <meta charset="utf-8">
    <title>Search Engine Analyzer Tool</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!-- Le styles -->
    <link href="static/css/bootstrap.css?v1" rel="stylesheet">
...
<div class="container">
    ...
    <div class="hero-unit">
        <center>
            <img src="static/img/biglogo.png"></br>
            <form method="get" action="./search.php">
                ...
                <div style = "width: 160px; text-align:left;display:none;">
    ...
    <footer>
        <p>© Search Engine Analyzer Tool 2022</p>
    </footer>
